...
INSTALLED_APPS = [
    ...
    "myapp",
    "crispy_forms",  # For form handling
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://rafi:gWl7G2tRolYgAbBQQ0X2iq4VStqcIAXO@dpg-d1culrali9vc739j03t0-a.ohio-postgres.render.com/reeftracker_4kzl',
        conn_max_age=600
    )
}
